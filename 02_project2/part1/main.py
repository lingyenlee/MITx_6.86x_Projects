...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    test_error = compute_test_error(test_x, test_y, theta, temp_parameter=1)
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    theta, cost_function_history = softmax_regression(train_x, train_y_mod3, temp_parameter=1, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
...
# print("Test error for trained pca is {}".format(test_error_pca))
...
test_error_pca10_cube = compute_test_error(test_cube, test_y, theta_cube, temp_parameter=1)

print("Test error for trained pca with cubic is {}".format(test_error_pca10_cube))